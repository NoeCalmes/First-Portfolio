u<?php $activePage = 'contact'; // Page active?>
...
<head>
    ...
    <title>Portefolio-NoéCalmes</title>
    <link rel="icon" type="image/gif" href="img/nc.ico" />
...
<div id="loader-overlay">
    ...
    <div class="header">
        <div class="left">
            <a class="title-principal" href="index.php">
                <p>Noé <span>Calmes</span> </p>
            </a>
        </div>

        <div class="right">
            <button class="toggleLanguage" id="toggle-buttont">
                <img src="img/langue/anglais.png" alt="" id="toggle-image">
            </button>

            <div class="dark-mode-toggle-wrapper">
                <button class="btn-toggle">
                    <img src="img/mode sombre/Vector.svg" alt="" id="toggle-image">
                </button>
            </div>
        </div>
    ...
    <article>
        <div class="container">
            <div class="article-left">
                ...
                <div class="reseau">
                    ...
                    <a href="https://github.com/NoeCalmes">
                        <button class="grille">
                            ...
                            <img src="img/article-left/reseau/github.svg" alt="">
                        </button>
                    </a>
                    ...
                    <a href="https://codepen.io/noecalmes">
                        <button class="grille">
                            <div class="round-background"></div>
                            <img src="img/article-left/reseau/codepen.svg" alt="">
                        </button>
                    </a>
                    ...
                    <a href="https://www.linkedin.com/in/noe-calmes-627564236/">
                        <button class="grille">
                            <div class="round-background"></div>
                            <img class="linkedin" src="img/article-left/reseau/linkedin.svg" alt="">
                        </button>
                    </a>
                ...
                <div class="contact">
                    <div class="icon">
                        <img src="img/article-left/Phone.svg" alt="">
                    ...
                    <div class="icon2">
                        <img src="img/article-left/email.svg" alt="">
                    ...
                    <div class="icon3">
                        <img src="img/article-left/location.svg" alt="">
                        <h1 class="dark fr">Localisation</h1>
                        <h1 class="dark en" style="display:none;">Location</h1>
                        <a
                            href="https://www.google.com/search?q=paris&rlz=1C1VDKB_frFR1061FR1061&oq=paris&gs_lcrp=EgZjaHJvbWUqBwgAEAAYjwIyBwgAEAAYjwIyDwgBEC4YFBiHAhixAxiABDIJCAIQIxgnGIoFMhIIAxAAGBQYgwEYhwIYsQMYgAQyCggEEAAYsQMYgAQyDQgFEAAYgwEYsQMYgAQyDQgGEAAYgwEYsQMYigUyBggHEEUYPNIBBzU0M2owajSoAgCwAgA&sourceid=chrome&ie=UTF-8&si=ACFMAn8hieP5aE6nZoDwYPRSCYx5_Uwc38ze3lbhqasaLtnKdk-kcsWo1lPW66CvpBG5xrN2J0MsI_dU7XnxA36cQoAuTzwGVw%3D%3D&ictx=1&ved=2ahUKEwj7-r30gM6AAxXDQaQEHVB3Cn0QnZMFegQIVBAC">
                            <p class="grey">Millau, France</p>
                        </a>
                        <div class="line3"></div>
                    </div>


                    <a href="pdf/cv-noecalmes.pdf"><button class="download fr">Télécharger mon CV
                            <div class="icon-1">
            ...
            <?php include 'article/article4.php'; ?>
    ...
    <footer class="mobile">
        <div class="container-footer">
            ...
            <div class="card-flex">
                ...
                <div class="card-footer">
                    <a href="tel:0611223344">
                        <img class="un" src="img/article-left/Phone.svg" alt="">
                        <h1>Téléphone</h1>
                        <p>+0658308210</p>
                    </a>
                </div>
                ...
                <div class="card-footer">
                    <a
                        href="https://www.google.com/search?q=millau&sca_esv=561015036&rlz=1C1VDKB_frFR1061FR1061&sxsrf=AB5stBh-PVJ3AJbh5wbr0xJkCcSxGhWYZQ%3A1693322015271&ei=HwvuZNCcEPi0i-gPtOCbmA4&ved=0ahUKEwiQqNeJlIKBAxV42gIHHTTwBuMQ4dUDCA8&uact=5&oq=millau&gs_lp=&sclient=gws-wiz-serp">
                        <img class="deux fr" src="img/article-left/loca/location2.svg" alt="">
                        <img class="deux en" style="display:none;" src="img/article-left/loca/location2.svg" alt="">
                        <h1>Localisation</h1>
                        <p>Millau</p>
                    </a>
                </div>
                <div class="card-footer">
                    <a href="mailto:noecalmes@gmail.com">
                        <img class="trois" src="img/article-left/email.svg" alt="">
                        <h1>Email</h1>
                        <p>noecalmes.pro</p>
                    </a>
                </div>
            ...
            <div class="end">
                <h1 class="copi">© Copyright 2023 </h1>
                <p class="droit fr"> - Noé Calmes. Tous droits réservés.</p>
                <p class="droit en" style="display:none;"> - Noé Calmes.  All rights reserved. .   . </p>
            </div>
